...
SELECT codigo_pedido, fecha_pedido, codigo_cliente
from pedido
...
-- ################### CONSULTAS MULTITABLA Dia5 ######################

-- 1.Devuelve un listado que muestre solamente los clientes que no han realizado ningún pago.
Select distinct cliente.nombre_cliente as NombreCliente
from cliente
...
Select empleado.nombre, oficina.codigo_oficina, oficina.ciudad, oficina.pais, oficina.telefono
from empleado
inner join oficina on oficina.codigo_oficina = empleado.codigo_oficina
left join cliente on cliente.codigo_empleado_rep_ventas = empleado.codigo_empleado
where cliente.codigo_empleado_rep_ventas is null;

-- Desarrollado por Paula Alejandra Muñoz Peñaranda / ID.1.095.953.057
